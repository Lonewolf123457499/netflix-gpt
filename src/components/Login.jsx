...
import { checkValidateData } from "../assets/utility/validate";
const Login = () => {
...
const [displayMessage,setDisplayMesssage]=useState(false);
  ...
  return (
    <div>
      <Header />
      <div className="bg-gradient-to-r from-cyan-500 to-blue-500 ... absolute w-full h-full ">
        <img
        ...
        <form action="">
          ...
          <div className="m-2">
            ...
            <div className="m-1 text-red-500 text-center">
              {displayMessage ? <p>Email OR Password is not valid!!</p> : ""}
            </div>
            <div className="py-4">
              <button
          ...
          <div>
            <Link to={"/signup"} className="text-red-500 underline px-4">
              Register Now!
            </Link>
          </div>
        </form>
